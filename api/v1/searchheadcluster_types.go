...
// SearchHeadClusterSpec defines the desired state of SearchHeadCluster
type SearchHeadClusterSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file

	// Foo is an example field of SearchHeadCluster. Edit searchheadcluster_types.go to remove/update
	Spec `json:",inline"`
...
// SearchHeadClusterStatus defines the observed state of SearchHeadCluster
