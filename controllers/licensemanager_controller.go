...
//+kubebuilder:rbac:groups=enterprise.splunk.poc,resources=licensemanagers,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=enterprise.splunk.poc,resources=licensemanagers/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=enterprise.splunk.poc,resources=licensemanagers/finalizers,verbs=update
...
func (r *LicenseManagerReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&enterprisev1.LicenseManager{}).
		Complete(r)
}
