...
//+kubebuilder:rbac:groups=enterprise.splunk.poc,resources=monitoringconsoles,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=enterprise.splunk.poc,resources=monitoringconsoles/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=enterprise.splunk.poc,resources=monitoringconsoles/finalizers,verbs=update
...
func (r *MonitoringConsoleReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	instance := &enterprisev1.MonitoringConsole{}
	...
	if upgradeScenarioForMonitoringConsole(ctx, r.Client, instance) {
...
func (r *MonitoringConsoleReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&enterprisev1.MonitoringConsole{}).
		Complete(r)
}
