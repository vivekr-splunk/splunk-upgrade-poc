...
//+kubebuilder:rbac:groups=enterprise.splunk.poc,resources=searchheadclusters,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=enterprise.splunk.poc,resources=searchheadclusters/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=enterprise.splunk.poc,resources=searchheadclusters/finalizers,verbs=update
...
func (r *SearchHeadClusterReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&enterprisev1.SearchHeadCluster{}).
		Complete(r)
}
